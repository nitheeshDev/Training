...
using Microsoft.AspNetCore.Http; // Add this using statement for IFormFile
using Microsoft.Extensions.Configuration;
using System.Data;
using System.Data.SqlClient;

namespace Core_CRUD.Repository
{
    public class studenRepository
    {
        ...
        public void inserStudent(Register student, IFormFile imageFile)
        {
            ...
            student.Profile = ConvertToBytes(imageFile);
        ...
        public List<Register> getStudents(int id)
        {
            Connect();
